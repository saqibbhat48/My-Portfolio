...
const Projects = () => {
  return (
    ...
    transition={{ duration: 1.5, delay: 0 }} className="max-w-6xl mx-auto p-5 mt-56" id="projects">
      <div className="pb-8">
      ...
      <motion.div initial={{ opacity: 0, scale:0.8}}
          ...
          transition={{ duration: 1.5, delay: 0 }} className="grid sm:grid-cols-2 md:grid-cols-3 sm:gap-8 md:gap-4 gap-10">
        ...
        <div  className="transform transition-transform duration-300 ease-linear hover:scale-105 overflow-hidden shadow-lg shadow-black group container rounded-md flex flex-col justify-center items-center mx-auto bg-cover relative bg-slate-700">
          ...
          <h1 className="font-bold text-center text-xl underline">CryptoCurrency Web App</h1>
          <p className="p-1 leading-4">A web application 
            that provides users with information about the top 50 cryptocurrencies, crypto news, and upcoming exchanges.</p>
        ...
        <div  className="transform transition-transform duration-300 ease-linear hover:scale-105 overflow-hidden shadow-lg shadow-black group container rounded-md flex flex-col justify-center items-center mx-auto bg-cover relative bg-slate-700">
          ...
          <div className="p-2 text-white">
          <h1 className="font-bold text-center text-xl underline">Interior Design Website</h1>
          <p className="p-1 leading-4">A modern, responsive website for an interior design startup</p>
            <div className="flex gap-4 justify-center mt-2">
              <h3 className="bg-slate-900 p-2 rounded-xl">React.js</h3>
        ...
        <div  className="transform transition-transform duration-300 ease-linear hover:scale-105 overflow-hidden shadow-lg shadow-black group container rounded-md flex flex-col justify-center items-center mx-auto bg-cover relative bg-slate-700">
          ...
          <div className="opacity-0 group-hover:opacity-95 bg-[gray]/70 absolute inset-0 flex flex-col justify-center items-center">
            ...
            <div className="pt-8 text-center">
              <a
                href="https://tictactoe-bysaqib.netlify.app/"
                target="_main"
              >
                <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-black font-bold text-lg hover:bg-black hover:text-white duration-300 ease-linear">
                  Live
          ...
          <div className="p-2 text-white">
          <h1 className="font-bold text-center text-xl underline">Tic-Tac-Toe Game</h1>
          <p className="p-1 leading-4">This entertaining game of tic tac toe that allows two players to take turns marking spaces in a 3x3 grid and much more.</p>
            <div className="flex gap-4 justify-center mt-2">
              <h3 className="bg-slate-900 p-2 rounded-xl">React.js</h3>
              <h3 className="bg-slate-900 p-2 rounded-xl">Tailwind CSS</h3>
            </div>
        ...
        <div className="transform transition-transform duration-300 ease-linear hover:scale-105 overflow-hidden shadow-lg shadow-black group container rounded-md flex flex-col justify-center items-center mx-auto bg-cover relative bg-slate-700">
          ...
          <div className="opacity-0 group-hover:opacity-95 bg-[gray]/70 absolute inset-0 flex flex-col justify-center items-center">
            ...
            <div className="pt-8 text-center">
              <a
                href="https://todolist-bysaqib.netlify.app/"
                target="_main"
              >
                <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-black font-bold text-lg hover:bg-black hover:text-white duration-300 ease-linear">
                  Live
          ...
          <div className="p-2 text-white">
          <h1 className="font-bold text-center text-xl underline">To-Do List</h1>
          <p className="p-1 leading-4">A web application that allows users to manage their tasks effectively, including features like adding tasks with due dates, marking tasks as completed, editing task names and deleting tasks.</p>
            <div className="flex gap-4 justify-center mt-2">
        ...
        <div className="transform transition-transform duration-300 ease-linear hover:scale-105 overflow-hidden shadow-lg shadow-black group container rounded-md flex flex-col justify-center items-center mx-auto bg-cover relative bg-slate-700">
          ...
          <div className="p-2 text-white">
          <h1 className="font-bold text-center text-xl underline">Currency Converter</h1>
          <p className="p-1 leading-4">Currency Converter is a simple React application that allows users to convert currencies based on real-time exchange rates.</p>
            <div className="flex gap-4 justify-center mt-2">
              <h3 className="bg-slate-900 p-2 rounded-xl">React.js</h3>
              <h3 className="bg-slate-900 p-2 rounded-xl">Tailwind CSS</h3>
            </div>
